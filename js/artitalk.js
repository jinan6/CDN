...
function shuoshuo_emoji_QQ(){
    ...
    if(!$("#shuoshuo_emoji_QQ").hasClass('shuoshuo-hide')){
        return ;
    }
    if(!$("#shuoshuo_emoji_BiliBili").hasClass('shuoshuo-hide')){
        document.getElementById('shuoshuo_emoji_BiliBili').classList.add('shuoshuo-hide');
    }
    if(!$("#shuoshuo_emoji_custom").hasClass('shuoshuo-hide')){
        document.getElementById('shuoshuo_emoji_custom').classList.add('shuoshuo-hide');
    }
    if(!$("#shuoshuo_emoji_Tieba").hasClass('shuoshuo-hide')){
        document.getElementById('shuoshuo_emoji_Tieba').classList.add('shuoshuo-hide');
    }
    document.getElementById('shuoshuo_emoji_QQ').classList.remove('shuoshuo-hide');
}
...
function shuoshuo_emoji_BiliBili(){
    ...
    if(!$("#shuoshuo_emoji_QQ").hasClass('shuoshuo-hide')){
        document.getElementById('shuoshuo_emoji_QQ').classList.add('shuoshuo-hide');
    }
    if(!$("#shuoshuo_emoji_custom").hasClass('shuoshuo-hide')){
        document.getElementById('shuoshuo_emoji_custom').classList.add('shuoshuo-hide');
    }
    ...
    document.getElementById('shuoshuo_emoji_BiliBili').classList.remove('shuoshuo-hide');
}
function shuoshuo_emoji_Custom(){
    ...
    document.getElementById('shuoshuo_emoji_custom').classList.remove('shuoshuo-hide');
}
...
document.getElementById("artitalk").innerHTML = sting;
  ...
  function shuoshuo_emoji_lovefancybox(){
    ...
    document.getElementById('switch_3').classList.remove('zuiliangdezai');
    document.getElementById('switch_4').classList.remove('zuiliangdezai');
    if($("#shuoshuo_emojiswitch").hasClass('shuoshuo-hide')){
        document.getElementById('shuoshuo_emoji_Tieba').classList.remove('shuoshuo-hide');
        ...
        document.getElementById('shuoshuo_emojiswitch').classList.remove('shuoshuo-hide');
        ...
        document.getElementById('shuoshuo_emojiswitch').classList.add('shuoshuo-hide');
    }
  }
  function artitalk(){
    var currentUser = AV.User.current();
  ...
  function Show(){
    document.getElementById('shade').classList.remove('shuoshuo-hide');
    document.getElementById('modal').classList.remove('shuoshuo-hide');
  }
 function Hide(){
    document.getElementById('shade').classList.add('shuoshuo-hide');
    document.getElementById('modal').classList.add('shuoshuo-hide');
  }
  function Login(){
  ...
  function hideuser(){
    document.getElementById('shade').classList.add('shuoshuo-hide');
    document.getElementById('userinfo').classList.add('shuoshuo-hide');
  }
  function Louout(){
    AV.User.logOut();
    location.reload();
  ...
  function swtichuser(){
    ...
    var currentUser = AV.User.current();
    if(currentUser){
      document.getElementById('userinfo').classList.remove('shuoshuo-hide');
  ...
  function hide4(){
    document.getElementById('shade').classList.add('shuoshuo-hide');
      document.getElementById('shanchur').classList.add('shuoshuo-hide');
  }
  function shuoshuo_delete(id){
    var currentUser = AV.User.current();
    if(currentUser){
      document.getElementById('shade').classList.remove('shuoshuo-hide');
      document.getElementById('shanchur').classList.remove('shuoshuo-hide');
  ...
  function really_shanchu(id){
    ...
    deletes.destroy().then(function (success){
      document.getElementById('shade').classList.remove('shuoshuo-hide');
      document.getElementById('shanchu').classList.remove('shuoshuo-hide');
    }, function (error){
...
function upload_in(){
    document.getElementById('shade').classList.remove('shuoshuo-hide');
    document.getElementById('upload_parttwo').classList.remove('shuoshuo-hide');
}
function upload_out(){
    document.getElementById('shade').classList.add('shuoshuo-hide');
    document.getElementById('upload_parttwo').classList.add('shuoshuo-hide');
}
//上传ui
